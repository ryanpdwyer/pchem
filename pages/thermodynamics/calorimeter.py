"""2nd Law Calorimeter - Ice/Water Phase Transitions"""
import copy
...
def draw(current, container, ice):
    ...
    ice_color = "#f2f3fc"
    water_color = "#d7f1fa"
    water = patches.Rectangle((0.1, 0.1), 0.8, 0.8, linewidth=1, ec="0", fc=water_color)

    waterCu = patches.Rectangle((0.1, 0.1), 0.8, 0.8, linewidth=3, ec="#b87333", fc=water_color)
    ...
    container_dict = {
        ...
        "Cu in Saltwater": [patches.Rectangle((0.05, 0.05), 0.9, 0.9, linewidth=1, ec="0", fc="#d7f1fa"), waterCu]
    }

    if ice > 0:
        iceHeight = 0.8/1*ice
        icePatch = patches.Rectangle((0.1, 0.9-iceHeight), 0.8, iceHeight, linewidth=0, fc=ice_color)
